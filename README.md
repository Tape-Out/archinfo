...
System configuration and identification registers.
...
Planned, not started. Work starts when a reference SoC needs to read the chip's identity and configuration.
